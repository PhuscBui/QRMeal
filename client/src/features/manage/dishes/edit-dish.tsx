...
export default function EditDish({
  ...
  console.log('EditDish data', data)
  ...
  const previewAvatarFromFile = file ? URL.createObjectURL(file) : image || undefined
    ...
    >
      <DialogContent className='sm:max-w-[600px] max-h-screen overflow-auto'>
        <DialogHeader>
          ...
          <DialogDescription>{t('updateDishDesc')}</DialogDescription>
        </DialogHeader>
        <Form {...form}>
          <form
            noValidate
                  ...
                  <FormItem>
                    <div className='flex gap-2 items-start justify-start'>
                      <Avatar className='aspect-square w-[100px] h-[100px] rounded-md object-cover'>
                        ...
                        <AvatarFallback className='rounded-none'>{name || t('name')}</AvatarFallback>
                      </Avatar>
                      <input
                        type='file'
                        accept='image/*'
                ...
                render={({ field }) => (
                  <FormItem>
                    <div className='grid grid-cols-4 items-center justify-items-start gap-4'>
                      ...
                      <div className='col-span-3 w-full space-y-2'>
                        <Textarea id='description' className='w-full' placeholder={t('enterDescription')} {...field} />
                        <FormMessage />
                      </div>
                    </div>
                  </FormItem>
        ...
        <DialogFooter>
          ...
          >
            {updateDishMutation.isPending || uploadMediaMutation.isPending ? t('updatingDish') : t('update')}
          </Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
