...
import EditDish from '@/features/manage/dishes/edit-dish'
import AddDish from '@/features/manage/dishes/add-dish'
...
const getColumns = (t: ReturnType<typeof useTranslations>): ColumnDef<DishItem>[] => [
  {
    accessorKey: 'index',
    header: t('no'),
