...
import { OrderTableContext } from '@/features/manage/orders/order-table'
import OrderDetail from '@/features/manage/orders/order-detail'
import { DeliveryInfoComponent } from '@/features/manage/orders/delivery-info'
      ...
      return (
        <div className='space-y-2'>
                ...
                <PopoverContent>
                  <div className='flex flex-wrap gap-2'>
                    ...
                    <div className='space-y-1 text-sm'>
                      ...
                      <div>
                        {tCommon('status')}: {getOrderStatus(order.status)}
                      </div>
                    </div>
                  </div>
                </PopoverContent>
          ...
          <div className='text-sm space-y-1'>
            <div>
              {t('totalItems')}: <Badge variant='outline'>{totalItems}</Badge>
            </div>
    ...
    cell: function TypeCell({ row }) {
      ...
      return (
        <Badge variant={row.original.order_type === 'dine-in' ? 'default' : 'destructive'}>
          {row.original.order_type === 'dine-in' ? t('dineIn') : t('delivery')}
        </Badge>
      )
    }
  },
          ...
          <Popover>
            ...
            <PopoverContent className='w-96'>
              <div className='space-y-3'>
                <h4 className='font-semibold'>{t('individualOrders')}</h4>
