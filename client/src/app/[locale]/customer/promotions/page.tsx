            ...
            <div className='flex items-center justify-between mb-4'>
              <div className='flex items-center gap-3'>
                ...
                <div>
                  ...
                  <p className='text-yellow-100'>{t('level')}: {loyaltyInfo.name}</p>
                </div>
              </div>
              <Badge className='bg-white text-orange-500 font-semibold'>{loyaltyInfo.currentPoints} {t('point')}</Badge>
            </div>
            ...
            <div className='space-y-3'>
              {loyaltyInfo.nextLevel !== 'Maximum' && (
                <>
                  <div className='flex justify-between text-sm'>
                    <span>{t('levelUpProgress')} {loyaltyInfo.nextLevel}</span>
                    <span>
              ...
              <div className='grid grid-cols-2 md:grid-cols-3 gap-4 mt-4'>
                <div className='flex items-center gap-2 text-sm'>
                  ...
                  <span>{t('cumulative')}: {loyaltyInfo.totalSpend.toLocaleString('vi-VN')}$</span>
                </div>
                <div className='flex items-center gap-2 text-sm'>
                  <Users className='h-4 w-4 fill-white' />
                  <span>{t('purchases')}: {loyaltyInfo.visitCount}</span>
                </div>
                <div className='flex items-center gap-2 text-sm'>
                    ...
                    <ul className='space-y-1'>
                      {promo.conditions.min_spend && (
                        <li className='text-xs text-muted-foreground flex items-start gap-2'>
                          ...
                          <span>{t('minOrder')}: {promo.conditions.min_spend.toLocaleString('en-VN')}$</span>
                        </li>
                      )}
