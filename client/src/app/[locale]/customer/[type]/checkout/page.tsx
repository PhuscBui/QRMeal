            ...
            <Card>
              ...
              <CardContent>
                <div className='p-3 border rounded-lg bg-blue-50 dark:bg-blue-950/20'>
                  ...
                  <p className='text-sm text-blue-700 dark:text-blue-300 mt-1'>{t('capacity')}: {tableInfo.capacity} {t('people')}</p>
                </div>
              </CardContent>
            </Card>
          )}
          ...
          <Card>
            <CardHeader>
              <CardTitle className='flex items-center justify-between'>
                ...
                <span className='text-sm text-muted-foreground'>({cartItems.length} {t('items')})</span>
              </CardTitle>
            </CardHeader>
            <CardContent>
              ...
              <CardContent className='space-y-4'>
                <div className='space-y-2'>
                  <div className='flex justify-between text-sm'>
                    <span>{t('subtotal')} ({cartItems.reduce((sum, item) => sum + item.quantity, 0)} {t('items')})</span>
