...
const getShiftsColumns = (t: any): ColumnDef<ShiftType>[] => [
  {
    accessorKey: 'index',
    header: t('no'),
...
const getRequestsColumns = (t: any): ColumnDef<ShiftType>[] => [
  {
    accessorKey: 'index',
    header: t('no'),
    cell: ({ row }) => <div>{row.index + 1}</div>
    ...
    >
      <DialogContent className='sm:max-w-[600px]'>
        <DialogHeader>
          ...
          <DialogDescription>
            {t('reviewShiftRequestDesc', { name: shift.staff_info?.name })}
          </DialogDescription>
        </DialogHeader>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <Textarea
                      placeholder={
                        reviewAction === 'approve' ? t('addNoteOptional') : t('explainRejection')
                      }
