...
export default function OrderStatics({
  ...
  statics: Statics
  tableList: TableListResType['result']
      ...
      >
        <DialogContent className='max-h-full overflow-auto'>
          {selectedServingGuest && (
            <DialogHeader>
              <DialogTitle>{t('guestsAtTable', { tableNumber: selectedTableNumber })}</DialogTitle>
            </DialogHeader>
          )}
          <div>
            {selectedServingGuest &&
                ...
                <div className='flex flex-col gap-2'>
                  <TooltipProvider>
                    <Tooltip>
                      ...
                      <TooltipContent>
                        {getOrderStatus(OrderStatus.Pending)}: {countObject[OrderStatus.Pending] ?? 0} {t('orderLabel')}
                      </TooltipContent>
                    </Tooltip>
                    ...
                    <Tooltip>
                      ...
                      <TooltipContent>
                        {getOrderStatus(OrderStatus.Processing)}: {countObject[OrderStatus.Processing] ?? 0} {t('orderLabel')}
                      </TooltipContent>
                    </Tooltip>
                    <Tooltip>
                      <TooltipTrigger>
                      ...
                      <TooltipContent>
                        {getOrderStatus(OrderStatus.Delivered)}: {countObject[OrderStatus.Delivered] ?? 0} {t('orderLabel')}
                      </TooltipContent>
                    </Tooltip>
                  </TooltipProvider>
                </div>
