      ...
      <CardHeader className="relative">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <CardDescription>
              <span className="@[540px]/card:block hidden">View your performance metrics</span>
          ...
          <div className="flex items-center gap-2">
            ...
            >
              <ToggleGroupItem value="orders" aria-label="Toggle Orders" className="px-3 text-xs">
                Orders
              </ToggleGroupItem>
              <ToggleGroupItem value="revenue" aria-label="Toggle Revenue" className="px-3 text-xs">
                Revenue
              </ToggleGroupItem>
              <ToggleGroupItem value="visitors" aria-label="Toggle Visitors" className="px-3 text-xs">
                Visitors
              </ToggleGroupItem>
            </ToggleGroup>
