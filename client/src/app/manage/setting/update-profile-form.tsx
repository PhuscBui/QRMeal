    ...
    <Form {...form}>
      ...
      >
        <Card x-chunk='dashboard-07-chunk-0'>
          <CardHeader>
            <CardTitle className='text-center text-2xl'>Personal Information</CardTitle>
                  ...
                  render={({ field }) => (
                    <FormItem className='w-full'>
                      <div className='grid gap-2'>
                        ...
                        <Input id='name' type='text' className='w-full' placeholder='Enter your name' {...field} />
                  ...
                  render={({ field }) => (
                    <FormItem className='w-full'>
                      <div className='grid gap-2'>
                        ...
                        <Input id='email' type='text' className='w-full' placeholder='Enter your email' {...field} />
                        <FormMessage className='text-xs text-red-500' />
                      </div>
                    </FormItem>
                  )}
