...
import { RevenueChart } from '@/app/manage/reports/revenue-chart'
import { DishStatistics } from '@/app/manage/reports/dish-statistics'
      ...
      <div className='space-y-2'>
        ...
        {revenueQuery.isLoading || dishQuery.isLoading ? (
          ...
          <>
            ...
            <DishStatistics data={dishQuery.data?.payload.result ?? {
              bestSellers: [],
              leastOrdered: [],
              neverOrdered: [],
              totalDishes: 0,
