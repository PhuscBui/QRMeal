    ...
    >
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            <span className='bg-foreground text-primary-foreground rounded p-1'>{categoryDelete?.name}</span> will be
              ...
              <div className='flex items-start justify-between'>
                <div className='flex-1'>
                  ...
                  <p className='text-sm text-muted-foreground mt-1'>
                    {category.dish_count ?? 0} {category.dish_count === 1 ? 'dish' : 'dishes'}
                  </p>
                </div>
              </div>
            </CardHeader>
