...
const mockTableList = [
  { _id: "1", number: 1, capacity: 2, location: "Window", status: "Available", token: "token1" },
  { _id: "2", number: 2, capacity: 4, location: "Window", status: "Reserved", token: "token2" },
  { _id: "3", number: 3, capacity: 2, location: "Bar", status: "Available", token: "token3" },
  { _id: "4", number: 4, capacity: 6, location: "Center", status: "Available", token: "token4" },
  { _id: "5", number: 5, capacity: 4, location: "Patio", status: "Reserved", token: "token5" },
  { _id: "6", number: 6, capacity: 8, location: "Private Room", status: "Available", token: "token6" },
  { _id: "7", number: 7, capacity: 2, location: "Window", status: "Hidden", token: "token7" },
  { _id: "8", number: 8, capacity: 4, location: "Patio", status: "Available", token: "token8" },
]
