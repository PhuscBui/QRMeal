...
export const envConfig = {
  ...
  dbCustomerPromotionsCollection: process.env.MONGODB_CUSTOMER_PROMOTIONS_COLLECTION as string,
  dbLoyaltiesCollection: process.env.MONGODB_LOYALTIES_COLLECTION as string,
  ...
  dbDishReviewsCollection: process.env.MONGODB_DISH_REVIEWS_COLLECTION as string,
  dbAttendancesCollection: process.env.MONGODB_ATTENDANCES_COLLECTION as string,
  dbChatMessagesCollection: process.env.MONGODB_CHAT_MESSAGES_COLLECTION as string,
  dbChatSessionsCollection: process.env.MONGODB_CHAT_SESSIONS_COLLECTION as string,
  dbDeliveriesCollection: process.env.MONGODB_DELIVERIES_COLLECTION as string,
  dbImageSearchLogsCollection: process.env.MONGODB_IMAGE_SEARCH_LOGS_COLLECTION as string,
  dbOrderGroupsCollection: process.env.MONGODB_ORDER_GROUPS_COLLECTION as string,
  dbPaymentsCollection: process.env.MONGODB_PAYMENTS_COLLECTION as string,
  dbRecommendationsCollection: process.env.MONGODB_RECOMMENDATIONS_COLLECTION as string,
  dbShiftsCollection: process.env.MONGODB_SHIFTS_COLLECTION as string,
