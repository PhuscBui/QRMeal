...
export const PROMOTIONS_MESSAGE = {
  ...
  MIN_SPEND_MUST_BE_GREATER_THAN_0: 'Min spend must be greater than 0',
  MIN_VISITS_IS_REQUIRED: 'Min visits is required',
  MIN_VISITS_MUST_BE_A_NUMBER: 'Min visits must be a number',
  MIN_VISITS_MUST_BE_GREATER_THAN_0: 'Min visits must be greater than 0',
  ...
  MIN_LOYALTY_POINTS_MUST_BE_GREATER_THAN_0: 'Min loyalty points must be greater than 0',
